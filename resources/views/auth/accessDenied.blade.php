...
<htm>
    <head>
        <meta charset="UTF-8">
        <title>{{ trans('labels.accessDenied') }} - {{ trans('labels.siteTitle') }}</title>
    ...
    <body style="display: flex; justify-content: center; align-items: center; height: 100vh;">
        <div class="card" style="background-color: #ff9999; border-radius: 10px;">
            ...
            <p style="color: black; font-size: 20px;">{{ trans('labels.accessDeniedMessage') }}</p>
